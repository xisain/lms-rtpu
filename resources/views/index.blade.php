...
<div class="min-h-screen bg-gradient-to-b from-[#f0f7ff] to-white flex items-center justify-center">
    <div class="flex flex-col md:flex-row items-center justify-between w-11/11 max-w-6xl mx-auto">
        ...
        <div class="mt-8 md:mt-0">
            <img src="/images/logo.png" alt="Logo RTPU" class="w-[230px] md:w-[290px]">
        </div>
    </div>
</div>
...
<div class="min-h-screen bg-[#009999] flex flex-col items-center py-10">
    <div class="flex flex-col md:flex-row items-center justify-between bg-white w-11/12 max-w-lg rounded-[80px] border border-gray-300 p-4 shadow-lg mb-10">
        ...
        <div>
            <img src="/images/logo-pnj.png" alt="Logo RTPU" class="w-[50px] md:w-[70px] object-contain mr-7">
        </div>
    </div>

    <div class="w-11/12 max-w-5xl">
        <div class="aspect-[16/9] mb-4">
            <img src="/images/background1.jpg" alt="Gambar 1" class="w-full h-full object-cover rounded-xl shadow-lg">
        </div>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="aspect-[16/9]">
                <img src="/images/background1.jpg" alt="Gambar 2" class="w-full h-full object-cover rounded-xl shadow-lg">
            </div>
            <div class="aspect-[16/9]">
                <img src="/images/background2.jpeg" alt="Gambar 3" class="w-full h-full object-cover rounded-xl shadow-lg">
            </div>
            <div class="aspect-[16/9]">
                <img src="/images/background3.jpg" alt="Gambar 4" class="w-full h-full object-cover rounded-xl shadow-lg">
            </div>
        </div>
    </div>
</div>
