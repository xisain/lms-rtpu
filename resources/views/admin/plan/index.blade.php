                    ...
                    <table class="min-w-full divide-y divide-gray-200" id="planTable">
                        <thead class="bg-gray-50">
                            <tr class="">
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray uppercase tracking-wider max-w-[200px]">
                                    Description
                                </th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($plan as $plans)
                                <tr class="hover:bg-gray-50 transition duration-150">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 max-w-[200px] overflow-hidden text-ellipsis truncate">
                                        {{ $plans->description }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
