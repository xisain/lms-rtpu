    ...
    <div class="container mx-auto px-4 py-6">
        <div class="max-w mx-auto">
            ...
            <form id="courseForm" action="{{ route('course.store') }}" method="POST"
                class="bg-white shadow-md rounded-lg p-6" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="col-span-2">
                            <label for="reviewer_id" class="block text-sm font-medium text-gray-700 mb-2">Reviewer Laporan Akhir <span class="text-red-500"> * </span></label>
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="text" name="whatsapp_group" id="whatsapp_group" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="https://chat.whatsapp.com/...">
                        </div>
                                ...
                                <div id="finalTaskSection" class="hidden">
                                    <div class="bg-white border border-gray-200 rounded-lg p-4">
                                        <label for="instruksi" class="block text-sm font-medium text-gray-700 mb-2">
                                            Instruksi Laporan Akhir <span class="text-red-500"> * </span>
                                        </label>
